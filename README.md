...
| Delete code from paragraph                | Removes a code from the current paragraph of a Data File or Code File. The reference is also removed from the corresponding other file.                                                                                                |   ![Icon](./docs/icons/minus-circle.svg)   | `mod+shift+d`  | Quadro                                                                                                           |
| Delete Code File and all references to it | Moves the Code File to the trash, _and_ deletes all references to it.                                                                                                                                                                  |     ![Icon](./docs/icons/x-circle.svg)     |       —        | Quadro                                                                                                           |
