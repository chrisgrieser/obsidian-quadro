...
| ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- | ------------------------------------------------------ | ----------------------------------------------- |
| Assign codes                         | Any selected text is also highlighted (overlapping highlights not supported).                                                                   | `ctrl+shift+a` (Windows)<br>`cmd+shift+a` (macOS) | "Quadro: Assign code to paragraph"                     | Quadro                                          |
...
| Remove code from paragraph           | Removes a code from the current paragraph of a data file, and the corresponding code file                                                       | `ctrl+shift+r` (Windows)<br>`cmd+shift+r` (macOS) | "Quadro: Remove code from paragraph"                   | Quadro                                          |
