...
| Overview of Codes                         | Creates an overview of all codes in a nested list with code assignment counts.                                                                                                                                                         |   ![Icon](./assets/circle-equal.svg)   |       —        | Quadro                                                                                                           |
...
| Overview of Extraction Types       | Creates an overview of all Extraction Type Templates and their dimensions.                                                                                                                                                                                                                              |  ![Icon](./assets/square-equal.svg)   |       —        | Quadro                                                   |
